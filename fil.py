        ...
        for i in range(818181):
            ...
            if "Available" in isav:
                ...
                try:
                    ...
                    await turbo.send_file(event.chat_id, 'https://t.me/xx3bD/203', caption=f'''Leader : @xx_YaBh
User ⤷ @{username}
Save ⤷ ch
Clicks ⤷ {trys}
turbo ⤷ @xx_YaBh
''')
                    await turbo.send_file("i5tbot", 'https://t.me/xx3bD/203', caption=f'''Leader : @xx_YaBh
User ⤷ @{username}
Save ⤷ Flod - turbo
Clicks ⤷ {trys}
turbo ⤷ @xx_YaBh
